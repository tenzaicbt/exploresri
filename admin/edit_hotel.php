        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <?php if (!empty($hotel['image'])): ?>
                    <img src="../images/<?= htmlspecialchars($hotel['image']) ?>" alt="Hotel Image"
            ...
            <!-- Gallery Upload -->
            <div class="mb-4">
                <label class="form-label fw-semibold">Upload More Gallery Images</label>
                <input type="file" name="images[]" class="form-control" accept="image/*" multiple>
            </div>

            <!-- Current Gallery Thumbnails -->
            <?php if (!empty($hotel['image_gallery'])): ?>
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        foreach ($gallery as $img) {
                            if (!empty($img)) {
                                echo '<div class="position-relative border rounded bg-white shadow-sm" style="width: 140px;">';
                                echo '<img src="../images/' . htmlspecialchars($img) . '" class="img-fluid rounded"
                                ...
                                echo '<a href="delete_image.php?hotel_id=' . $hotel_id . '&image=' . urlencode($img) . '" 
                                  ...
                                  style="width: 25px; height: 25px; font-size: 14px; line-height: 1;">&times;</a>';
                                echo '</div>';
                            }
                        }
                        ?>
