...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
  <div class="container">
    <a class="navbar-brand" href="index.php">ExploreSri</a>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <?php session_start(); 
          if(isset($_SESSION['user_id'])): ?>
            ...
            <li class="nav-item"><a class="nav-link" href="logout.php">Logout (<?php echo htmlspecialchars($_SESSION['user_name']); ?>)</a></li>
        <?php else: ?>
