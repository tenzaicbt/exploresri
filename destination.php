...
<div class="bg-dark py-3">
  <div class="container">
    <ul class="nav nav-pills justify-content-center flex-wrap gap-2" id="sectionTabs">
      <li class="nav-item">
        <a class="nav-link active" href="#">Things To Do</a>
      </li>
      <li class="nav-item">
...
<div class="container destination-info mt-4">
  <h1 class="mb-3"><?php echo htmlspecialchars($dest['name']); ?></h1>
    ...
    <div class="col-md-4">
      <div class="card bg-dark text-white border-0 shadow h-100">
        ...
        <div class="card-body">
          ...
          <a href="destination.php?id=<?php echo $other['destination_id']; ?>" class="btn btn-warning text-dark">View</a>
        </div>
      </div>
    </div>
    <?php endwhile; ?>
